...
The `multimput` package was originally intended to provide the data and code to replicate the results of @Onkelinx2016. The functions were all rewrite to make them more user-friendly and more generic. The original code and data are currently only available for historic purposes. 
